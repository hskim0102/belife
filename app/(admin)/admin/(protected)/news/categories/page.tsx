...
export const metadata: Metadata = { title: '소식 구분 관리' }
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-xl font-black text-gray-900 mt-2">소식 구분 관리</h1>
        <p className="text-sm text-gray-400 mt-1">
          소식을 분류하는 구분입니다. 소식 작성 화면의 분류 선택과 소식 페이지의 필터에 사용됩니다.
